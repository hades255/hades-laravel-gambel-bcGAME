                ...
                <div class="kt-notification__item">
                    <div class="kt-notification__item-details">
                        <div class="kt-notification__item-title" style="font-family: 'Open Sans'; font-size: 14px">
                            `+type+` <strong>`+(t['sum'] > 0 ? '+' : '')+t['sum']+` USD.</strong>
                        </div>
                        <div class="kt-notification__item-time" style="font-family: 'Open Sans'; font-size: 13px;">
                            `+(t['data'] == null ? '' : (prefix == null ? 'Данные: ' : prefix+": ")+t['data']+' | ')+'Баланс: '+t['current']+' USD.'+`
                        </div>
                    </div>
                </div>
            `);
...
$(document).ready(function() {
    ...
    $(window).scroll(function () {
        ...
        send('#notification', '/admin/notification/send/'+$('#edit_id').val()+'/'+$('#edit_title').val()+'/'+$('#edit_message').val(), function() {
